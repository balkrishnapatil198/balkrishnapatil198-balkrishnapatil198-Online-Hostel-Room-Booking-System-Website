	...
	<div class="main">
		...
		<div id="wrapper" class="w3ls_wrapper w3layouts_wrapper">
			<div id="steps" style="margin:0 auto;" class="agileits w3_steps">
				<form id="formElem" name="formElem" action="../includes/hostel_add.php" method="post" class="w3_form w3l_form_fancy">
          ...
          <legend>Add Hostel</legend>
            <div class="agilecontactw3ls-grid">
              <div class="agile-con-centre">
                <form action="../includes/hostel_add.php" method="POST">
                  <input type="text" name="hostel_name" placeholder="HOSTEL NAME" required="required">
                  <input type="text" name="hostel_room" placeholder="Hostel Rooms" required="required">
              
                  <div class="send-button">
                    <input type="submit" name="hostel_add_submit">
                  </div>
                </form>
              </div>
              <div class="clear"></div>
				...
				<form id="formElem" name="formElem" action="../includes/hostel_remove.php" method="post" class="w3_form w3l_form_fancy">
				<fieldset class="step w3_agileits">
          <legend>Remove Hostel</legend>
            <div class="agilecontactw3ls-grid">
              <div class="agile-con-centre">
                <form action="../includes/hostel_remove.php" method="POST">
                  <input type="text" name="hostel_name" placeholder="HOSTEL NAME" required="required">
                  <input type="password" name="pass" placeholder="ADMIN PASSWORD" required="required">
                  <div class="send-button">
                    <input type="submit" name="hostel_remove_submit">
                  </div>
                </form>
              </div>
              <div class="clear"></div>
