	...
	<div class="main">
		...
		<div id="wrapper" class="w3ls_wrapper w3layouts_wrapper">
			<div id="steps" style="margin:0 auto;" class="agileits w3_steps">
				<form id="formElem" name="formElem" action="../includes/mess_add.php" method="post" class="w3_form w3l_form_fancy">
          ...
          <legend>Add Mess</legend>
            <div class="agilecontactw3ls-grid">
              <div class="agile-con-centre">
                <form action="../includes/mess_add.php" method="POST">
                  <input type="text" name="mess_name" placeholder="Mess NAME" required="required"><br>
				  <label class="radio-inline"><input type="radio" id="veg" name="type" value="Veg">Veg</label>
					
				  <label class="radio-inline"><input type="radio" id="nonveg" name="type" value="Non-veg">Non-Veg</label>
					
				  <label class="radio-inline"><input type="radio" id="both" name="type" value="Both" checked>Both</label>
					<input type="text" name="Size" placeholder="Mess Size" required="required">
					<textarea rows = "5" cols = "60" name="description" placeholder="Mess Description" required="required"></textarea>
                  <div class="send-button">
                    <input type="submit" name="mess_add_submit">
                  </div>
                </form>
              </div>
              <div class="clear"></div>
				...
				<form id="formElem" name="formElem" action="../includes/mess_remove.php" method="post" class="w3_form w3l_form_fancy">
				<fieldset class="step w3_agileits">
          <legend>Remove Mess</legend>
            <div class="agilecontactw3ls-grid">
              <div class="agile-con-centre">
                <form action="../includes/mess_remove.php" method="POST">
                  <input type="text" name="mess_name" placeholder="Mess NAME" required="required">
                  <input type="password" name="pass" placeholder="ADMIN PASSWORD" required="required">
                  <div class="send-button">
                    <input type="submit" name="mess_remove_submit">
                  </div>
                </form>
              </div>
              <div class="clear"></div>
